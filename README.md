...
1. Create or open the repository that serves `phiwm.github.io`.
2. Copy all files in this folder into the repository root.
3. Commit and push.
4. In GitHub repository settings, enable GitHub Pages for the main branch/root folder if it is not already enabled.
5. The page should be available at both:
   - `https://phiwm.github.io/`
   - `https://phiwm.github.io/CORL2026.html`

## Items to update later

- OpenReview submission URL.
- Submission deadline, notification date, and camera-ready/poster-upload date.
- Room assignment and exact workshop start time.
